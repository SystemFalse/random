...
public class ObjectGenerator<T> implements Generator<T> {
     ...
     */
    protected static Executable getRandomCreator(List<Executable> creators, Random random) {
        long weightSum = 0;
     ...
     *                              constructor
     */
    protected static <T> T generate(Type type, RandomValue value, int depth, Random random) {
     ...
     */
    @SuppressWarnings("unchecked")
    protected static <T> T random(Type type, RandomValue value, int depth, Random random) {
     ...
     */
    protected static Object[] random(Parameter[] params, RandomValue value, Random random) {
     ...
     */
    private static byte randomByte(RandomValue value, Random random) {
     ...
     */
    private static char randomChar(RandomValue value, Random random) {
     ...
     */
    private static short randomShort(RandomValue value, Random random) {
     ...
     */
    private static int randomInt(RandomValue value, Random random) {
     ...
     */
    private static long randomLong(RandomValue value, Random random) {
     ...
     */
    private static float randomFloat(RandomValue value, Random random) {
     ...
     */
    private static double randomDouble(RandomValue value, Random random) {
     ...
     */
    private static String randomString(RandomValue value, Random random) {
     ...
     */
    private static <T extends Enum<T>> T randomEnum(Class<T> clazz, RandomValue value, Random random) {
     ...
     */
    private static <T extends Record> T randomRecord(Class<T> clazz, RandomValue value, Random random) {
     ...
     */
    @SuppressWarnings("unchecked")
    private static List<?> randomList(Type listType, RandomValue value, Random random, int minSize,
    ...
    private static Set<?> randomSet(Type setType, RandomValue value, Random random, int minSize, int maxSize,
     ...
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    private static Map<?, ?> randomMap(Type mapType, RandomValue value, Random random, int minSize, int maxSize,
     ...
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    protected static <T> T randomValue(Type type, RandomValue value, Random random) {
