...
public @interface RandomValue {
     ...
     * value is ignored if {@link #floatValues()} is specified. Default is {@code 0}.
     ...
     * value is ignored if {@link #floatValues()} is specified. Default is {@code 1}.
     ...
     * value is ignored if {@link #doubleValues()} is specified. Default is {@code 0}.
     ...
     * value is ignored if {@link #doubleValues()} is specified. Default is {@code 1}.
     ...
     * value is ignored if {@link #stringValues()} is specified. Default is {@code 1}.
