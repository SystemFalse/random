...
public final class Generators {
    ...
    private static MethodHandle asHandle(Constructor<?> constructor, boolean publicOnly) throws IllegalAccessException,
        ...
        return (publicOnly ? MethodHandles.publicLookup() : MethodHandles.lookup()).findConstructor(
                constructor.getDeclaringClass(), MethodType.methodType(void.class, constructor.getParameterTypes()));
    }
    ...
    private static MethodHandle asHandle(Method method, boolean publicOnly) throws IllegalAccessException,
            NoSuchMethodException {
        MethodHandles.Lookup lookup = (publicOnly ? MethodHandles.publicLookup() : MethodHandles.lookup());
        return Modifier.isStatic(method.getModifiers()) ?
                lookup.findStatic(method.getDeclaringClass(), method.getName(),
                        MethodType.methodType(method.getReturnType(), method.getParameterTypes())) :
                lookup.findVirtual(method.getDeclaringClass(), method.getName(),
                        MethodType.methodType(method.getReturnType(), method.getParameterTypes()));
    }
